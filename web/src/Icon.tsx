...
export default ({ type, style }: { type: IconTypes; style?: any }) => {
  switch (type) {
    ...
    case IconTypes.AppStore:
      return appStore(style);
    case IconTypes.GooglePlay:
      return googlePlay(style);
    default:
      return null;
  }
};
...
const googlePlay = (style: object) => {
  return (
    <svg
      ...
      className="svg-inline--fa fa-google-play fa-w-16"
      role="img"
      style={style}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
...
const appStore = (style: object) => {
  return (
    <svg
      ...
      data-prefix="fab"
      data-icon="app-store"
      className="svg-inline--fa fa-app-store fa-w-16"
      role="img"
      style={style}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 512 512"
